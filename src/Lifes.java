/*
 * Lifes.java allows to create, control and draw a bit map that represents the spiderman´s lifes
 * Author: Jassael Ruiz
 * Version: 1.0
 */
...
public class Lifes {
	...
	int Life[] = { 0x00000000, 0x0F81F000, 0x1FC3F800, 0x3FE7FC00, 0x7FFFFE00,
			...
			0x00180000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
	...
	int l_colors_matrix[][] = {
			...
			{ 8, 8, 8, 8, 0, 0, 0, 0, 0, 8, 8, 8, 8, 8, 8, 0, 0, 0, 0, 0, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 0, 6, 6, 6, 6, 6, 0, 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 0, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 0, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 0,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 0, 6, 6, 1, 1, 1, 6, 6, 6, 6, 0, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6,
					0, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 0, 6, 6, 1, 6, 1, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,
					0, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 0, 6, 6, 1, 1, 1, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,
					0, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			...
			{ 8, 0, 6, 6, 1, 6, 1, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6,
					0, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 0, 6, 1, 1, 1, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0, 8, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 6, 6, 0, 8, 8, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 8, 8, 8, 0, 6, 6, 6, 6, 6, 6, 0, 8, 8, 8, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 8, 8, 8, 8, 0, 6, 6, 6, 6, 0, 8, 8, 8, 8, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
			{ 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 0, 6, 6, 0, 8, 8, 8, 8, 8, 8, 8, 8,
					8, 8, 8, 8, 8, 8, 8, 8, 8, 8 },
